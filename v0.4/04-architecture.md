...
- **Persisted synthesis** → a user-saved cross-source synthesis stored as a new `human-created` DL output, under the **user's own SSO**, born `human-created`; durable and not recomputable ([07 Level 4](07-strategy.md)).
